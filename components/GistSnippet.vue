<template>
  <div class="gist mb-5" v-if="dataFetched">
    ...
    <div class="flex justify-between my-2">
      <div class="flex">
        ...
        <div class="flex flex-col">
          ...
          <p class="font-fira_retina text-xs text-menu-text">
      ...
      <!-- details and stars -->
      <div
        class="flex text-menu-text font-fira_retina text-xs justify-self-end lg:mx-2"
      >
    ...
    <div
      :id="'comment' + gist.id"
      class="flex hidden justify-between text-menu-text font-fira_retina mt-4 pt-4 border-top"
    >
